...
| **Omdia (Informa)** | **DRAM Memory Intelligence Service** and **NAND Memory Intelligence Service**, monthly pricing updates. https://omdia.tech.informa.com/advance-your-business/semiconductors/dram-memory-intelligence-service | `citations@omdia.com` — manually verified before outreach was sent; see the photonics shortlist |
