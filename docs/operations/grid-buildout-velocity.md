...
- **The seven 1930s CAISO dates.** `1930-01-01`, `1930-02-26`, `1930-03-01`, `1931-04-01`, `1932-06-01`, `1933-12-01`, `1935-01-01`. Independently confirmed as the publisher's own stored values — an independent reader returns the same dates. Every one is a `target_in_service_prior_vintage` milestone read from a *Previous In-Service* column, so none feeds a published metric. Canonical evidence records what the source said.
