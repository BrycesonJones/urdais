...
(
  ...
  'Richest observed H100 offer-level structure and the only venue exposing per-offer availability, but the Terms of Use prohibit automated collection and separately prohibit using the data to construct or maintain an index. Remains usable as research already lawfully gathered and as the shape for synthetic test fixtures. No further live retrieval without a separate written agreement.',
...
(
  ...
  'runpod-gpu-types', 'Runpod GPU types catalog', 'catalog_price_interface',
  'https://rest.runpod.io/v1/gpuTypes', true,
  'api_key', 'production_blocked', 'not_permitted', 'not_permitted', true,
  'Exposes minimum pod GPU count and a four-level per-datacenter availability signal conditional on requested GPU count, which is the strongest Grade 3 availability shape found. The Terms of Service prohibit automated access and systematic retrieval to compile a database without written permission.',
  '{"reviewed_on": "2026-09-13", "documents": [{"title": "Terms of Service | Runpod", "url": "https://www.runpod.io/legal/terms-of-service", "version_date": "March 24, 2026", "clauses": [{"axis": "collection", "text": "access or use the Site or the Service through automated or non-human means, whether through a bot, script or otherwise"}, {"axis": "collection", "text": "Except as may be the result of standard search engine or Internet browser usage, use, launch, develop, or distribute any automated system, including without limitation, any spider, robot, cheat utility, scraper, or offline reader that accesses the Site"}, {"axis": "data_use", "text": "Systematically retrieve data or other content from the Site to create or compile, directly or indirectly, a collection, compilation, database, or directory without written permission from us."}, {"axis": "data_use", "text": "Use the Service as part of any effort to compete with us."}]}]}'::jsonb
),
(
