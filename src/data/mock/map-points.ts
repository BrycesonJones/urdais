 ...
 * to exercise both colours. Delete this list when the backend supplies
 * real points.
 */
export const DEMO_MAP_POINTS: readonly UrdaisMapPoint[] = [
  { id: "demo-1", name: "Demo Point 1", longitude: -84.388, latitude: 33.749, mappingStatus: "mapped" },
  { id: "demo-2", name: "Demo Point 2", longitude: -122.419, latitude: 37.775, mappingStatus: "unmapped" },
  { id: "demo-3", name: "Demo Point 3", longitude: -0.128, latitude: 51.507, mappingStatus: "mapped" },
  { id: "demo-4", name: "Demo Point 4", longitude: 8.682, latitude: 50.111, mappingStatus: "unmapped" },
  { id: "demo-5", name: "Demo Point 5", longitude: 103.82, latitude: 1.352, mappingStatus: "mapped" },
  { id: "demo-6", name: "Demo Point 6", longitude: 139.692, latitude: 35.69, mappingStatus: "unmapped" },
  { id: "demo-7", name: "Demo Point 7", longitude: 151.209, latitude: -33.868, mappingStatus: "mapped" },
