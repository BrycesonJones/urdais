...
export function LiquidChromeSection() {
  return (
    <section className="relative h-[320px] w-full md:h-[420px] lg:h-[520px]">
      ...
      <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center gap-2 px-6 text-center [text-shadow:0_1px_12px_rgba(0,0,0,0.5)]">
        <h1 className="text-4xl font-semibold tracking-tight text-neutral-50">{SITE_NAME}</h1>
        <p className="text-lg text-neutral-300">{SITE_TAGLINE}</p>
      </div>
    </section>
  );
}
