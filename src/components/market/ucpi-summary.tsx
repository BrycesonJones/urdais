...
export function UcpiSummary({ index, snapshot, series }: UcpiSummaryProps) {
  return (
    <article
      ...
      className="flex flex-col gap-5 rounded-xl border border-white/10 bg-[#111111] p-5 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.07),0_0_0_1px_rgba(255,255,255,0.03),0_10px_32px_rgba(0,0,0,0.45),0_0_28px_rgba(255,255,255,0.035)] transition-colors hover:border-white/15 sm:p-6"
    >
