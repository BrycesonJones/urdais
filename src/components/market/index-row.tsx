  ...
  return (
    <li className="flex items-center justify-between gap-4 py-3">
      <div className="min-w-0">
        <p className="text-sm font-semibold text-neutral-950">{index.symbol}</p>
        <p className="truncate text-xs text-neutral-500">{index.name}</p>
      </div>
      <div className="shrink-0 text-right tabular-nums">
        <p className="text-sm font-medium text-neutral-950">
          {formatNumber(index.value)}{" "}
          <span className="text-xs font-normal text-neutral-500">{index.unit}</span>
        </p>
