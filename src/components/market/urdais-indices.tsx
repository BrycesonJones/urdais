...
export function UrdaisIndices({ indices }: { indices: IndexSnapshot[] }) {
  return (
    <aside
      ...
      className="rounded-xl border border-white/10 bg-[#111111] p-5 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06),0_0_0_1px_rgba(255,255,255,0.02),0_8px_28px_rgba(0,0,0,0.4),0_0_24px_rgba(255,255,255,0.025)] transition-colors hover:border-white/15 sm:p-6"
    >
